...
- [x] **Phase 3: 测试回归** - 覆盖成功/失败路径并完成最小验证。（完成于 2026-02-28）
- [x] **Phase 4: 补充真实环境测试** - 创建真实环境测试脚本和数据集。（完成于 2026-02-28）
...
Plans:
- [x] 03-01: 单测新增与执行验证（覆盖 AI 改写成功路径和异常回退路径）
...
| 3. 测试回归 | 1/1 | Complete | 2026-02-28 |
| 4. 补充真实环境测试 | 1/1 | Complete | 2026-02-28 |
...
Plans:
- [x] 04-01: 创建真实环境测试脚本和数据集（覆盖典型企业名改写、复杂句子结构、无企业名 query 和边界情况）
